    ...
    if (isset($_POST['update_status'])) {
        ...
        if ($exam_id && $st_id) {
            ...
            if ($st_id == 4) {
                ...
                $backup_sql = "INSERT INTO backup (fileName, description, courseCode, courseDescription, studentCount, classSection, file, examInstructions, st_id, user_id, sub_id) SELECT fileName, description, courseCode, courseDescription, studentCount, classSection, file, examInstructions, st_id, user_id, sub_id FROM exam WHERE id = ?";
